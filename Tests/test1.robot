...
This is sample test case
    ...
    #Open Browser  http://www.google.com  chrome  options=add_argument("--headless");add_argument("--disable-gpu");add_argument("--disable-dev-shm-usage")  executable_path="/usr/local/bin/chromedriver-linux64/chromedriver"
